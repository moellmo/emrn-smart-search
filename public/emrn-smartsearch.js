(() => {
  ...
  console.log("[EMRN SmartSearch] layout cleanup script loaded");
  ...
  style.textContent = `
    ...
    .emrn-smart-products-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:20px;align-items:stretch}
    ...
    .emrn-smart-product-img{height:220px;display:flex;align-items:center;justify-content:center;padding:22px;border-bottom:1px solid #f1eeee;text-decoration:none;background:#fff;flex:0 0 auto}
    .emrn-smart-product-img img{max-width:100%;max-height:100%;object-fit:contain}
    .emrn-smart-product-body{padding:18px;display:flex;flex-direction:column;flex:1}
    .emrn-smart-stars{color:#999;letter-spacing:2px;font-size:15px;margin-bottom:12px;flex:0 0 auto}
    .emrn-smart-product-name{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;color:#252735;text-decoration:none;font-size:16px;font-weight:900;line-height:1.36;min-height:44px;max-height:44px}
    .emrn-smart-product-name:hover{color:#c34d50}
    .emrn-smart-variant{color:#c34d50;font-size:13px;font-weight:900;margin:10px 0;line-height:1.4;min-height:55px;max-height:55px;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden}
    .emrn-smart-meta{display:flex;gap:8px;flex-wrap:wrap;margin:8px 0 10px;min-height:26px}
    .emrn-smart-meta span{background:#f3f4f6;border-radius:999px;padding:6px 8px;color:#555;font-size:11px;font-weight:800;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
    .emrn-smart-price{font-size:24px;font-weight:400;color:#252735;min-height:32px;margin:8px 0 14px}
  ...
  function showOverlay(){if(isResultsPage)return;ensureOverlay();positionOverlay();overlay.hidden=false;overlay.style.display="block";document.body.classList.add("emrn-smartsearch-active")}
