(() => {
  ...
  style.textContent = `
    ...
    .emrn-smartsearch-item{display:grid;grid-template-columns:58px minmax(0,1fr) 104px;gap:12px;align-items:start;padding:10px;border:1px solid transparent;border-radius:15px;text-decoration:none;color:#1f2937;transition:all .14s ease;min-width:0}
    ...
    .emrn-smartsearch-copy{min-width:0}
    ...
    .emrn-smartsearch-meta{color:#666;font-size:12px;margin-top:4px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
    .emrn-smartsearch-option{color:#c34d50;font-size:12px;line-height:1.25;font-weight:900;margin-top:3px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
    .emrn-smartsearch-view{background:#f3f4f6;color:#1f2937;border-radius:999px;padding:7px 10px;font-size:12px;font-weight:900;white-space:nowrap;text-align:center;align-self:center}
